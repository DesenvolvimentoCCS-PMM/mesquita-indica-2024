  ...
  return (
    <div className="m-auto w-11/12 max-w-3xl relative md:-top-4">
      ...
      <div className="relative z-50">
        <div className="flex flex-col gap-4 items-center absolute -top-6 left-4 z-50 sm:left-20 md:flex-row md:-left-4 md:items-end md:top-14">
        ...
        <div className="flex flex-col gap-4 items-center absolute top-4 right-4 z-50 sm:left-0 sm:top-10 md:flex-row md:top-52 md:left-4 md:items-start lg:top-56">
          <SmallCard
            title={
              <h1>
      ...
      <div className="flex relative sm:top-0 md:top-4 h-[520px] md:h-[340px] lg:h-[400px]">
        ...
        <img
          ...
          alt="Boneco do Oscar"
          id="oscar-voting"
          className="z-50 hidden absolute sm:block w-44 -right-4 -top-4 sm:right-2 sm:w-64 md:w-52 md:-top-20 md:-right-4 lg:w-56"
        />
      </div>
    </div>
  );
